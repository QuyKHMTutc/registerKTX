...
public class AdminViewController {
    ...
    public String updatePhongStatus(@PathVariable Integer maPhong, @RequestParam String trangThai, RedirectAttributes redirectAttributes) {
    ...
    public String approveDon(@PathVariable Integer maDon, @RequestParam(required = false) Integer maPhong, RedirectAttributes redirectAttributes) {
        try {
    ...
    public String rejectDon(@PathVariable Integer maDon, @RequestParam String lyDo, RedirectAttributes redirectAttributes) {
        try {
            NhanVien admin = authService.getCurrentNhanVien();
            DonDangKy donDangKy = duyetDonService.getDonDangKyById(maDon);
    ...
    public String khoaTaiKhoan(@PathVariable Integer maTK, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("successMessage", "Đã khóa tài khoản " + taiKhoan.getTenDangNhap() + " thành công.");
        } catch (Exception e) {
    ...
    public String moKhoaTaiKhoan(@PathVariable Integer maTK, RedirectAttributes redirectAttributes) {
        try {
            ...
            taiKhoanRepository.save(taiKhoan);
            redirectAttributes.addFlashAttribute("successMessage", "Đã mở khóa tài khoản " + taiKhoan.getTenDangNhap() + " thành công.");
        } catch (Exception e) {
